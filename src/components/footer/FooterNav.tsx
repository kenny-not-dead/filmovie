...
export default function FooterNav() {
    ...
    <div className={classes.wrapper}>
        <div>
            ...
            {item.map(item => <Aitem item = {item} key={item.id}/>)}
        </div>
        ...
        <div>
            ...
            <p><FormattedMessage id='supportp1'/> <br/> <FormattedMessage id='supportp2'/></p>
            ...
            <a href="https://ask.ivi.ru/?_gl=1*1bzh0p4*_ga*MTAyOTM3NDg3NS4xNjc5ODEzNDI3*_ga_GETQ4387MJ*MTY4MTMyMDA2NC4zLjEuMTY4MTMyOTYwNC41OC4wLjA.">ask.ivi.ru</a>
            <p>
